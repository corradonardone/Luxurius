...
class Information(commands.Cog):
    ...
    async def profile(self,ctx,member:discord.Member=None):
        ...
        font = ImageFont.truetype("font\Nunito-Regular.ttf",38)
        akafont = ImageFont.truetype("font\Nunito-Regular.ttf",30)
        subfont = ImageFont.truetype("font\Nunito-Regular.ttf",25)
